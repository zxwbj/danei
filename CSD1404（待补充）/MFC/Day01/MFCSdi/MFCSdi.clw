...
NewFileInclude2=#include "MFCSdi.h"
LastPage=0
...
Type=0
HeaderFile=MFCSdi.h
ImplementationFile=MFCSdi.cpp
Filter=N

[CLS:CMFCSdiDoc]
Type=0
HeaderFile=MFCSdiDoc.h
ImplementationFile=MFCSdiDoc.cpp
Filter=N

[CLS:CMFCSdiView]
Type=0
HeaderFile=MFCSdiView.h
ImplementationFile=MFCSdiView.cpp
Filter=C
